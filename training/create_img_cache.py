...
def parse_args():
    ...
    p.add_argument("--model", required=True, help="HF repo or local dir (must have a VAE)")
    p.add_argument("--data_root", required=True, help="Directory containing images (recursively searched)")
    p.add_argument("--out_suffix", default=".img_cache", help="File suffix for saved latents(default: _cache)")
